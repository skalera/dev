...
wget -O /usr/bin/influx https://s3-us-west-2.amazonaws.com/skalera/vagrant/influx-0.9.4.1
wget -O /usr/bin/influxd https://s3-us-west-2.amazonaws.com/skalera/vagrant/influxd-0.9.4.1
